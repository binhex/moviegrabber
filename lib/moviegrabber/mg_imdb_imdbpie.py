...
def imdb_json_api(logger_instance, imdb_tt_id):
    ...
    try:
        ...
        logger_instance.warning(u"failed to download json from imdb api")
        return 1
    ...
    try:
        ...
        logger_instance.warning(u"failed to download json for imdb poster url")
    ...
    try:
        ...
        logger_instance.warning(u"failed to download json for imdb title")
    ...
    try:
        ...
        logger_instance.warning(u"failed to download json for imdb year")
    ...
    try:
        ...
        logger_instance.warning(u"failed to download json for imdb runtime")

    # Grab metadata from IMDb JSON for plot
    try:
        get_title_plot = imdb_instance.get_title_plot(imdb_tt_id)
    except imdbpie.exceptions.ImdbAPIError:
        logger_instance.warning(u"failed to download json for title plot")
        return 1
    ...
    try:
        ...
        logger_instance.warning(u"failed to download json for imdb plot")

    # Grab metadata from IMDb JSON for genres
    try:
        get_title_genres = imdb_instance.get_title_genres(imdb_tt_id)
    except imdbpie.exceptions.ImdbAPIError:
        logger_instance.warning(u"failed to download json for imdb title genres")
        return 1
    ...
    try:
        ...
        logger_instance.warning(u"failed to download json for imdb genres")

    # Grab metadata from IMDb JSON for ratings
    try:
        get_title_ratings = imdb_instance.get_title_ratings(imdb_tt_id)
    except imdbpie.exceptions.ImdbAPIError:
        logger_instance.warning(u"failed to download json for imdb title ratings")
        return 1
    ...
    try:
        ...
        logger_instance.warning(u"failed to download json for imdb ratings")
    ...
    try:
        ...
        logger_instance.warning(u"failed to download json for imdb ratings count")
    ...
    try:
        ...
        logger_instance.warning(u"failed to download json for imdb title credits")
        return 1
    ...
    try:
        ...
        logger_instance.warning(u"failed to download json for imdb writers")
    ...
    try:
        ...
        logger_instance.warning(u"failed to download json for imdb directors")
    ...
    try:
        ...
        logger_instance.warning(u"failed to download json for imdb characters")
